...
SECRET_KEY = 'django-insecure-s6(hm(f_uni_yprte51)h&yl8yjtejok!c3#7y1ii-wbu15xus'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),  # Optional: Adjust refresh token lifetime if needed
}
